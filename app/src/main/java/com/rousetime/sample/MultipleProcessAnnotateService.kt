...
class MultipleProcessAnnotateService : Service() {
    ...
    private var mBinder = object : IMultipleProcessServiceInterface.Stub() {
        ...
        override fun initStartup() {
            ...
            Handler(Looper.getMainLooper()).post {
                val multipleServiceConfig =  ProcessStoreUtils.getStoreConfig(this@MultipleProcessAnnotateService)
                        ...
                        override fun onCompleted(
                            ...
                            mServiceListener?.onCompleted(buildString {
                                ...
                                if (costTimesModels.isEmpty()) {
                                    ...
                                    append("\n")
                                    multipleServiceConfig.second.result.forEach {
                                        append("\n")
                                        append(
                ...
                StartupManager.Builder()
                    .setConfig(config)
                    .setStartupSortStore(multipleServiceConfig.second, multipleServiceConfig.first)
                    .build(this@MultipleProcessAnnotateService)
                    .start()
                    .await()
            }
        }
